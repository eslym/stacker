...
- `eslym/stacker:debian` - Latest stable release (Debian-based)
- `eslym/stacker:alpine` - Latest stable release (Alpine-based)
- `eslym/stacker:alpine-x.y.z` - Specific version on Alpine (e.g., `alpine-1.0.0`)
