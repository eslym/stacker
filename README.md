...
- `eslym/stacker:debian` - Latest stable release (Debian-based, explicit)
- `eslym/stacker:latest-debian` - Latest stable release (Debian-based, explicit)
...
- `eslym/stacker:alpine` - Latest stable release (Alpine-based, explicit)
